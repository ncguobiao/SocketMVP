...
import com.gb.sockt.accountcenter.mvp.presenter.RegistPresenter
...
//                            val data = Gson().fromJson<LoginBean>(jsonReader, LoginBean::class.java)
     ...
     * 保存登陆信息
     */
    private fun successLoginAndSave(data: com.gb.sockt.accountcenter.data.domain.LoginBean, loginType: String) {
