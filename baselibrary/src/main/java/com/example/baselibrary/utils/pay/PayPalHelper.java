package com.example.baselibrary.utils.pay;
...
public class PayPalHelper {
   ...
   //你所注册的APP Id
    private static final String CONFIG_CLIENT_ID = "Aai16hkFtzrB1BpnebR7psisCiNIa54n_sVWNG53J7YXLOGXRaFauoe7conyR2LMPevq6Tx-JwgS9_Mo";
...
//.merchantUserAgreementUri(Uri.parse("https://www.example.com/legal"));
    ...
    private PayPalPayment getStuffToBuy(String paymentIntent) {
        ...
        PayPalItem[] items =
                {
                        new PayPalItem("炸弹", 2, new BigDecimal("0.50"), "USD",
                                "sku-12345678"),
                        new PayPalItem("手枪", 1, new BigDecimal("1.00"),
                                "USD", "sku-zero-price"),
                        new PayPalItem("鱼雷", 5, new BigDecimal("0.2"),
                                "USD", "sku-33333")
                };
        //购物车小记
