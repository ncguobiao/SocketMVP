...
import com.example.baselibrary.utils.DataFromatUtils;
import com.example.baselibrary.utils.DateUtils;
import com.example.baselibrary.utils.SensorEventHelper;
        ...
        mlocationClient.setLocationListener(new AMapLocationListener() {
            ...
            public void onLocationChanged(AMapLocation aMapLocation) {
                ...
                if (mMapLocationChangeListener != null) {
                    ...
                    // 地图已经激活，通知蓝点实时更新，显示系统小蓝点
                    mMapLocationChangeListener.onLocationChanged(aMapLocation);
                    //获取定位时间
//                    Logger.d("定位时间"+aMapLocation.getTime());
//                    DateUtils.times();
//                    Logger.d("定位 onLocationChanged");
...
//                    locationInfo.setKey(df.format(date));
                    if (firstLocation) {
                        firstLocation = false;
    ...
    public void moveCamera(LocationInfo locationInfo1, LocationInfo locationInfo2) {
        try {
            ...
            Logger.e(TAG, "moveCamera: " + e.getMessage());
        }
    }
