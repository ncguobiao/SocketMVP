            ...
            when (msg?.what) {
                1 -> {
                    ...
                    if (mPresenter.getConnectState()) {
                        mPresenter.setCircleData(newpwd)
//                        Logger.d("setCircleData newpwd = $newpwd")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mac?.let {
            if (it.contains(":")) {
                val mac = it.replace(":", "")
                //获取新密码
                newpwd = AesEntryDetry.getPassword("sensor668", mac)
                Logger.d("password:$newpwd")
...
//            newpwd = SpUtils.getString(AppUtils.getContext(), ConstantSP.DEVICE_PWD)
//        }
...
//                val newpwd = AesEntryDetry.getPassword("sensor668", mac.replace(":", ""))
//                SpUtils.put(AppUtils.getContext(), ConstantSP.DEVICE_PWD, newpwd)
