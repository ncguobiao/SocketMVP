 ...
 */
open class BlueToothSingleControlImpl constructor(val context: Context?) : BlueToothSingleControl {
    ...
    override fun setMAC(mac: String?, bleConnectListener: BleConnectListener?): BlueToothSingleControlImpl {
        this.macAddress = mac
    ...
    override fun setResponseListener(baseBLEDataListener: BaseBLEDataListener): BlueToothSingleControl {
